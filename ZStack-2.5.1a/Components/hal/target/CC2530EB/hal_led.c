 ...
 * @fn      HalLedBlink
 *
 * @brief   Blink the leds  闪烁LED灯
 *
 * @param   leds       - bit mask value of leds to be blinked  要闪烁的LED灯的号
 *          numBlinks  - number of blinks       闪烁次数
 *          percent    - the percentage in each period where the led
 *                       will be on  //占空比
 *          period     - length of each cycle in milliseconds //闪烁周期
 *
 * @return  None
 ******************************************************************************/
